error id: file://<WORKSPACE>/src/main/java/com/bank/repository/internal/SimpleAccountRepository.java:com/bank/repository/AccountRepository#
file://<WORKSPACE>/src/main/java/com/bank/repository/internal/SimpleAccountRepository.java
empty definition using pc, found symbol in pc: com/bank/repository/AccountRepository#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 821
uri: file://<WORKSPACE>/src/main/java/com/bank/repository/internal/SimpleAccountRepository.java
text:
```scala
/*
