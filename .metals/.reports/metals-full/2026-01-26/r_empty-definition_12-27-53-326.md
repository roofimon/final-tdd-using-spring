error id: file://<WORKSPACE>/src/test/java/com/bank/config/xml/IntegrationITCase.java:org/hamcrest/MatcherAssert#
file://<WORKSPACE>/src/test/java/com/bank/config/xml/IntegrationITCase.java
empty definition using pc, found symbol in pc: org/hamcrest/MatcherAssert#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 727
uri: file://<WORKSPACE>/src/test/java/com/bank/config/xml/IntegrationITCase.java
text:
```scala
/*
